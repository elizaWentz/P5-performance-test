const COLORS = {
  burntOrange: '#DF540B',   // Het felle, levendige oranje
  lightBlue: '#EBC59B',     // Het iets lichtere, warm oranje/terracotta accent
  darkBrown: '#934C28',     // Het kenmerkende diepe olijf-/legergroen uit de foto
  mediumBrown: '#E2762A',   // Het warme roestbruin/chocoladebruin
  cream: '#655F2A',         // De zachte, warme crème/zandkleur
  nearBlack: '#B3753'      // De medium oker/bruintint voor de overige vlakken
};
