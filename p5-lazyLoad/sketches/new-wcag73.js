// Color palette
const BURNT_ORANGE = "#C34900";
const LIGHT_BLUE = "#A3523F";
const DARK_BROWN = "#A20000";
const MED_BROWN = "#6B3A36";
const CREAM = "#EBD9AB";
const NEAR_BLACK = "#444A64";
const BRIGHT_ORANGE = "#9D5700"; // Additional orange for more vibrancy
