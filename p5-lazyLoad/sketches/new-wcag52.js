...
function setup() {
  ...
  // Deep teal / cyan night palette (dark, cool glow)
  jungleBlack = color(220, 70, 5, 100);   // almost black navy
  jungleDark  = color(220, 60, 12, 100);  // very dark blue
  deepGreen   = color(210, 55, 22, 100);  // dark blue‑teal
  mossGreen   = color(200, 50, 36, 100);  // deep teal
  leafGreen   = color(190, 48, 52, 100);  // teal/aqua
  sunGreen    = color(185, 45, 68, 100);  // brighter aqua
  hazeGreen   = color(205, 35, 40, 100);  // smoky blue for mist/beams
  goldMist    = color(185, 35, 84, 100);  // pale cyan center glow
