...
function draw() {
  // Dark, deep orange background
  background(120, 45, 10); // tweak to (140, 60, 15) for a slightly brighter, richer orange
  ...
  drawLineFan(
    ...
    -height * 0.35,  // yMin far above canvas to avoid background at the very top
