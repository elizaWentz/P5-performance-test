// Color palette
const BURNT_ORANGE = "#D65113";
const LIGHT_BLUE = "#E2BFA1";
const DARK_BROWN = "#5A2F2B";
const MED_BROWN = "#6B3A36";
const CREAM = "#EFDDBE";
const NEAR_BLACK = "#E9D6BE";
const BRIGHT_ORANGE = "##2F1715"; // Additional orange for more vibrancy
