...
function drawRisoField() {
  ...
  risoTriangle(palette.teal, 0.88, -52, 34, 210, 270, 462, 42, 2, -1);
  risoTriangle(palette.coral, 0.82, 112, 274, 340, 40, 504, 280, -2, 2);
  risoTriangle(palette.yellow, 0.78, 408, 254, 620, 48, 778, 268, 3, 0);
  risoTriangle(palette.violet, 0.76, 690, 46, 842, 272, 1010, 54, -3, 2);
  risoTriangle(palette.teal, 0.72, 854, 280, 1038, 44, 1184, 250, 2, -2);
