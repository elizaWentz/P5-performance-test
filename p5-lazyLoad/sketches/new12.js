...
function setup() {
  ...
  jungleBlack = color(58, 36, 86, 100);
  jungleDark = color(92, 24, 78, 100);
  deepGreen = color(78, 48, 72, 100);
  mossGreen = color(122, 64, 48, 100);
  leafGreen = color(102, 56, 36, 100);
  sunGreen = color(134, 70, 20, 100);
  hazeGreen = color(138, 74, 12, 100);
  goldMist = color(142, 80, 6, 100);
