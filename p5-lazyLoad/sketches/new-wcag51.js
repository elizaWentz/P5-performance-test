...
function setup() {
  ...
  // Warm sunset palette (red → orange → yellow)
  // colorMode(HSB, 360, 100, 100, 100);

  jungleBlack = color(0,   90,  8, 100);   // very dark maroon
  jungleDark  = color(8,   92, 18, 100);   // deep red
  deepGreen   = color(16,  88, 32, 100);   // dark red‑orange
  mossGreen   = color(24,  90, 50, 100);   // mid orange
  leafGreen   = color(30,  92, 70, 100);   // bright orange
  sunGreen    = color(34,  95, 88, 100);   // light orange
  hazeGreen   = color(20,  70, 60, 100);   // soft orange (for mist / beams)
  goldMist    = color(40,  80,100, 100);   // warm yellow center
