...
function setup() {
  ...
  // Dark violet / magenta palette
  jungleBlack = color(285, 70, 5, 100);   // almost black purple
  jungleDark  = color(285, 65, 12, 100);  // very dark violet
  deepGreen   = color(290, 60, 22, 100);  // deep blue‑violet
  mossGreen   = color(300, 55, 36, 100);  // dark magenta
  leafGreen   = color(310, 60, 52, 100);  // mid magenta
  sunGreen    = color(320, 55, 70, 100);  // bright pink
  hazeGreen   = color(300, 40, 40, 100);  // soft violet for mist/beams
  goldMist    = color(325, 35, 85, 100);  // pale rose center glow
