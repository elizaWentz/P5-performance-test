...
function setup() {
  ...
  // Colors (tuned a bit darker for the "light" tone)
  colTeal = color(0, 80, 80);       // dark teal
  colCream = color(190, 175, 150);  // darker cream
  colDark = color(25, 26, 29);      // dark charcoal
...
function drawTile(x, y, w, h, flip) {
  ...
  if (!flip) {
    // Left teal triangle pointing right
    watercolorTriangle(
      x, y,
      x, y + h,
      midX, midY,
    ...
    // Right cream triangle pointing left
    watercolorTriangle(
      x + w, y,
      x + w, y + h,
      midX, midY,
