const BURNT_ORANGE = "#D44A26";
const LIGHT_BLUE = "#F25C3C";
const DARK_BROWN = "#D9A441";
const MED_BROWN = "#F28B70";
const CREAM = "#EFDDBE";
const NEAR_BLACK = "#D9A441";
const BRIGHT_ORANGE = "#FF8C42"; // Additional orange for more vibrancy
