function setup() {
  ...
  function draw() {
    ...
    for (let r of violetFacets) {
      // mix hot magenta and electric purple
      poly(r, '#ff4cff', '#a93bff', 120, 220);
    }
    pop();
  
    // --- NEON EDGES (PURPLE / MAGENTA) ---
    let neon = '#ff4cff'; // main neon magenta
    let neonAlt = '#d05bff'; // secondary neon purple
    ...
    // small facet edges with slightly different tone
